                  ...
                  child: ClipRRect(
                    ...
                    child: Column(
                      children: <Widget>[
                            ...
                            Text(
                              state.postDetails!.likes.isEmpty
                                  ...
                                  : (state.postDetails!.likes.length > 1
                                      ? state.postDetails!.likes[0].username +
                                          ' and ' +
                                          (state.postDetails!.likes.length - 1)
                                              .toString() +
                                          ' others'
                        ...
                        Container(
                            padding: EdgeInsets.all(10),
                            child: Text(state.postDetails!.description!,
                                style: GoogleFonts
                                    .pacifico()) //Text(post.description!),
                            ),
                        Divider(
                          color: Colors.grey,
                          height: 0,
                        ...
                        Container(
                            child: state.postDetails!.comments.isNotEmpty
                                ? ListView.builder(
                                    shrinkWrap: true,
                                    itemCount:
                                        state.postDetails!.comments.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      final item =
                                          state.postDetails!.comments[index];
                                      return SizedBox(
                                        child: ListTile(
