...
class RegisterFormBloc extends FormBloc<String, String> {
  ...
  final verifyPassword = TextFieldBloc(validators: [
    FieldBlocValidators.required,
  ]);
  ...
  final surname = TextFieldBloc(validators: [
    FieldBlocValidators.required,
  ]);
  ...
  final file = InputFieldBloc<File, Object>(
  ...
  Future<String?> _checkUsername(String? username) async {
    ...
    if (username != null) {
      ExistsUserResponse response =
          await userService.existsByUsername(username);
      if (response.exists) return 'That username is already taken';
      return null;
    }
    return null;
  }
  ...
  void onSubmitting() async {
    RegisterUserRequest request = RegisterUserRequest(
        ...
        birthday: DateFormat('yyyy-MM-dd').format(birthday.value),
        email: email.value);
