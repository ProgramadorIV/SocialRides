...
public class PasswordFriendlyValidator implements ConstraintValidator<PasswordFriendly, String> {
    int min, max;
    boolean upper, lower, number, alpha, special;


    @Override
    public void initialize(PasswordFriendly constraintAnnotation) {
